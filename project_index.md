...
|-------------|--------------|:----------:|:-------------:|:---------------:|:-------------:|-------------|-------|
| **P001** | Autoware and SVL Simulation | ✅ | - | - | - | Autonomous vehicle simulation with SVL and Autoware framework | [Video](https://www.dropbox.com/scl/fi/ygnbxx0pqw6shmrgc01pa/2022-01-21-21-05-19_2-autoware-Final.mp4?rlkey=3isp8b2jccr71of2l99mluf93&dl=0) |
...
| **P009** | Carter Tricycle Docking & Control | ✅ | - | ✅ | - | Visual servoing and precision docking control | [Video](https://www.dropbox.com/scl/fi/53u29nr03z9l0xowdfp3y/2025.5-isaacsim-carter-dock-battery-charge.mp4?rlkey=ynzuqfl5phmy52ksq3xerczjj&dl=0) \| [Image](assets/isaacsim-carter-dock-battery-charge.png) |
| **P010** | Warehouse Dancing Demo SMACC2+Nav2 | ✅ | ✅ | - | - | Mission-level behaviors and state machine architecture | [Video 1](https://www.dropbox.com/scl/fi/3stscugoptervds65ujqx/Dance-Party-at-AWS-Warehouse-Demo-1-gLH37M3e4e0.mkv?rlkey=izwjhwlei878nc9i16lk7r1id&dl=0) \| [Video 2](https://www.dropbox.com/scl/fi/uyq7pqbp2z6413pogawwn/Dance-Party-at-AWS-Warehouse-Demo-2-A3kmCQS_ww8.mkv?rlkey=z0cvx7nhpcy5i72in3wp221pg&dl=0) \| [Image](assets/aws-warehouse-dance-demo.png) |
| **P011** | Navigation and Manipulation Gazebo<br/>(`fetch_wine`, `tabletop_sort_boxes`) | ✅ | - | - | - | Combined navigation and manipulation in Gazebo | [Video](https://www.dropbox.com/scl/fi/79mcdakyy5q60whp7hbj3/Navigation-Manipulation-Gazebo.mp4?dl=0) |
| **P012** | GazeboSIM Large-Scale Simulation | ✅ | - | - | - | Microsoft large-scale simulation testing | [Video](https://www.dropbox.com/scl/fi/29rj34hqz3dl2/LargeScaleSimulation-GazeboSIM.mp4?dl=0) |
...
- **Motion Planning View:** DWA algorithm development and shared control innovation

### **P009 - Carter Tricycle Docking & Control**
- **Simulation View:** IsaacSim implementation and battery charging workflow
- **Motion Planning View:** Visual servoing algorithms and tricycle kinematic control

### **P010 - Warehouse Dancing Demo SMACC2+Nav2**
- **Simulation View:** Gazebo Classic demonstration and Nav2 integration
- **Architectures View:** SMACC2 state machine framework and mission control architecture

### **P015 - Mobile AI Platform Robotization**
- **Architectures View:** Hardware integration, embedded systems, and full-stack physical robotization
